...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *dotnet_lambda_sample*):

Restore dependencies
```
    cd "dotnet_lambda_sample"
    dotnet restore
```

Execute unit tests
```
    cd "dotnet_lambda_sample/test/dotnet_lambda_sample.Tests"
    dotnet test
```

Deploy application
```
    cd "dotnet_lambda_sample/src/dotnet_lambda_sample"
